    ...
    <div class="row">
      <div class="col-12 col-sm-5 col-md-4 col-xl-4" id="sidebar">
          ...
          <div class="d-grid gap-2">
            <button class="btn mt-4 btn-dark" type="button">Buscar orden</button>
            <button class="btn btn-dark" type="button">Crear orden</button>
            <button class="btn btn-dark" type="button">Eliminar orden</button>
          </div>
