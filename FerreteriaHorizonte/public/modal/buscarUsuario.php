<div class="modal fade" id="buscarUsuario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="submit" name="btnAccion" value="buscar" class="btn btn-primary m-2">Buscar</button>
        </form>
      </div>
